...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%69%68%6C%65.%6E%64%6C%65%6C%65%6E%69@%69%63%6C%6F%75%64.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-lastfm',
        title: 'Last FM',
        section: 'Socials',
        handler: () => {
          window.open("https://www.last.fm/user/sihle-", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://playguycartsih.substack.com/", "_blank");
        },
      },{
      id: 'light-theme',
